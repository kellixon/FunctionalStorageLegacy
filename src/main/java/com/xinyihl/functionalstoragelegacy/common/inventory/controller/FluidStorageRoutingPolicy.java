 ...
 */
public final class FluidStorageRoutingPolicy implements StorageRoutingPolicy<BigFluidStack, FluidStorageKey> {
    ...
    @Nonnull
    @Override
    public Collection<FluidStorageKey> getCompatibleAliases(@Nonnull BigFluidStack snapshot) {
        return Collections.emptyList();
    }

    @Override
    public boolean isEmptySlotEligible(@Nonnull IStorageHandler<BigFluidStack, FluidStorageKey> handler, int index, @Nonnull BigFluidStack request) {
        return true;
    }

    @Override
    public int getCandidatePriority(@Nonnull IStorageHandler<BigFluidStack, FluidStorageKey> handler, int index, @Nonnull BigFluidStack current, @Nonnull BigFluidStack request) {
